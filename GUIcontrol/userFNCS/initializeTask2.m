function [] = initializeTask2(hObject,handles,eventdata,extraData)


% do function
set(handles.prompt,'string','Click Load Raw Images to begin.');
...
set(handles.function1,'string','Load Raw Images');
set(handles.function2,'string','Detect Edge (A)');
set(handles.function3,'string','Crop (A)');
set(handles.function4,'string','Dilate (A)');
set(handles.function5,'string','Detect Edge (B)');
set(handles.function6,'string','Crop (B)');
set(handles.function7,'string','Dilate (B)');
