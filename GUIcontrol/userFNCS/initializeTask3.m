function [] = initializeTask3(hObject,handles,eventdata,extraData)


% do function
set(handles.prompt,'string','Click Load Images to begin');
...
set(handles.function1,'string','Load Images');
set(handles.function2,'string','Exclude Timepoints');
set(handles.function3,'string','Calculate Pixel Frequencies');
set(handles.function4,'string','Define Frequency Filter');
set(handles.function5,'string','Calculate Global Results');
